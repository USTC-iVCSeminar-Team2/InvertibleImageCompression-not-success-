        ...
        for _, batch in enumerate(train_loader):
            ...
            if rank == 0:
                ...
                if steps % a.stdout_interval == 0:
                    print('Epoch : {:d}, Steps : {:d}, Bit rate : {:4.3f}, Distortion : {}'.
                          format(epoch+1, steps, bit_rate, distortion))
                ...
                if steps % a.summary_interval == 0:
                    for key in output.keys():
                        if key != 'Rec_images':
                            sw.add_scalar("training/{}".format(key), output[key], steps)
                ...
                if steps % a.validation_interval == 0 and steps != 0:
                    ...
                    with torch.no_grad():
                        for j, batch in enumerate(validation_loader):
                            ...
                            rec_img, bpp = compressor.module.inference(img) if h.num_gpus > 1 else compressor.inference(img)
                        ...
                        sw.add_scalar("validation/bpp", val_bpp, steps)
...
def main():
    ...
    parser.add_argument('--model_name', default='inn_compressor', type=str)
    parser.add_argument('--training_dir', default=r'/data/liyao/vimeo/video_train/vimeo_train', type=str)
    parser.add_argument('--validation_dir', default=r'/data/liyao/vimeo/vimeo_test/vimeo_test', type=str)
    parser.add_argument('--checkpoint_path', default='/output/checkpoint', type=str)
    parser.add_argument('--config_file', default=r'/code/configs/config.json', type=str)
